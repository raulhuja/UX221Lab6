...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $sports_nutritionist_post_id = get_the_ID(); // Add this line to get the post ID
		    $sports_nutritionist__gallery_shortcode = get_post_gallery();

		    if (!empty($sports_nutritionist__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($sports_nutritionist__gallery_shortcode) . '</div>';
		    }
		?>
